<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes cerrar la sesión del resto de tus navegadores en todos tus dispositivos. A continuación se enumeran algunas de sus sesiones recientes; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, introduzca su contraseña para confirmar que desea cerrar la sesión de su otro navegador en todos sus dispositivos.') }}
